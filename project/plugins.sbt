...
// "1.8.0" "1.1.1" 1.3.1 1.5.1  1.6.0  1.7.0 1.8.0 1.10.0 1.16.0

// cross project and bundler
addSbtPlugin("org.portable-scala" % "sbt-scalajs-crossproject" % "1.3.2") //"1.3.2" "1.2.0"
addSbtPlugin("ch.epfl.scala" % "sbt-scalajs-bundler" % "0.21.1") // 0.21.0-RC1 0.20.0 "0.18.0"
